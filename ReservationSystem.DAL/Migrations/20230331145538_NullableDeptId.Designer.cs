...
namespace ReservationSystem.DAL.Migrations
{
    ...
    [Migration("20230331145538_NullableDeptId")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReservationSystem.DAL.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReservationSystem.DAL.Developer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReservationSystem.DAL.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeveloperTicket", b =>
                {
                    b.HasOne("ReservationSystem.DAL.Developer", null)
                        .WithMany()
                        .HasForeignKey("DevelopersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ReservationSystem.DAL.Ticket", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ReservationSystem.DAL.Ticket", b =>
                {
                    b.HasOne("ReservationSystem.DAL.Department", "Department")
                        .WithMany("Tickets")
